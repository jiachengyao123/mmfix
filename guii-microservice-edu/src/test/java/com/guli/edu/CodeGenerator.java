...
public class CodeGenerator {
    ...
    //private static String outputDir ="/Users/jia/idea/home_parent/home_after/src/main/java";//生成的位置
    ...
    private static String [] tables = {"user"};	//生成的表
    ...
    public void  testGenerator() {
        ...
        stConfig.setCapitalMode(true) //全局大写命名
                ...
                .setColumnNaming(NamingStrategy.underline_to_camel) //数据库字段映射到实体的命名策略
                .setEntityLombokModel(true) //lombok 模式 @Accessors(chain = true) setter 链式操作
                .setLogicDeleteFieldName("is_deleted") //逻辑删除字段
                .setEntityBooleanColumnRemoveIsPrefix(true); //去掉布尔值的 is_前缀
        //自动填充
        ...
        stConfig.setTableFillList(tableFills);//自动填充创建时间/更新时间
        stConfig.setVersionFieldName("version");//乐观锁列
        stConfig.setRestControllerStyle(true);//restful api风格控制器
